...
?>
		...
		<div class='container-login100'>
			<div class='wrap-login100 p-t-50 p-b-90'>
				<form class='login100-form validate-form flex-sb flex-w' action='includes\logout.inc.php' method='POST'>
					...
					<div class='container-login100-form-btn m-t-17'>
						...
						<button type='submit' name='logout-submit' class='login100-form-btn'>
							Logout
						</button>
			...
			<div class='wrap-login100 p-t-50 p-b-90'>
				<form class='login100-form validate-form flex-sb flex-w' action='includes\login.inc.php' method='POST'>
					...
					<div class='wrap-input100 validate-input m-b-16' data-validate = 'Username is required'>
						<input class='input100' type='text' name='mailuid' placeholder='Username'>
